...
- Profile: standard
- Generated pack path: `C:\Self-study\universal-learning-os\exports\generated\nodejs-standard`
- File count: 25
...
- `NODEJS_DOMAIN_CONTEXT.md`
- `NODEJS_SYLLABUS.md`
- `NODEJS_SKILL_GRAPH.md`
- `NODEJS_GLOSSARY_PROJECTS.md`
- `NODEJS_PRACTICE_ASSESSMENT_RULES.md`
...
- `docs/VISION.md`
- `domains/nodejs/ASSESSMENT_RULES.md`
- `domains/nodejs/DOMAIN.md`
- `domains/nodejs/GLOSSARY.md`
- `domains/nodejs/PRACTICE_RULES.md`
- `domains/nodejs/PROJECTS.md`
- `domains/nodejs/QUALITY_REVIEW.md`
- `domains/nodejs/SKILL_GRAPH.md`
- `domains/nodejs/SYLLABUS.md`

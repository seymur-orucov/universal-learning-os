# GoF and React Design Patterns Mentor OS Compact
...
- Canonical sources summarized: `specification/`, `core/`, `commands/`, `skills/`, and `domains/gof-react-patterns/`
...
- Keep GoF, TypeScript, JavaScript, React, Vitest, and React Testing Library terminology in English where natural.
...
- `START_LESSON`: teach the next appropriate GoF and React Design Patterns concept deeply enough for reasoning, then request one guided learner action.

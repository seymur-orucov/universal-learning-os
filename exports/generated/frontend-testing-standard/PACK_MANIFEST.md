...
- Profile: standard
- Generated pack path: `D:\Self study\universal-learning-os\exports\generated\frontend-testing-standard`
- File count: 25
...
- `FRONTEND_TESTING_DOMAIN_CONTEXT.md`
- `FRONTEND_TESTING_SYLLABUS.md`
- `FRONTEND_TESTING_SKILL_GRAPH.md`
- `FRONTEND_TESTING_GLOSSARY_PROJECTS.md`
- `FRONTEND_TESTING_PRACTICE_ASSESSMENT_RULES.md`
...
- `docs/VISION.md`
- `domains/frontend-testing/ASSESSMENT_RULES.md`
- `domains/frontend-testing/DOMAIN.md`
- `domains/frontend-testing/GLOSSARY.md`
- `domains/frontend-testing/PRACTICE_RULES.md`
- `domains/frontend-testing/PROJECTS.md`
- `domains/frontend-testing/QUALITY_REVIEW.md`
- `domains/frontend-testing/SKILL_GRAPH.md`
- `domains/frontend-testing/SYLLABUS.md`

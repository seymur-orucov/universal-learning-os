# Front-End System Design Upload File List

Use all 25 files from `exports/generated/frontend-system-design-standard/`:
...
21. `FRONTEND_SYSTEM_DESIGN_DOMAIN_CONTEXT.md`
22. `FRONTEND_SYSTEM_DESIGN_SKILL_GRAPH.md`
23. `FRONTEND_SYSTEM_DESIGN_SYLLABUS.md`
24. `FRONTEND_SYSTEM_DESIGN_PRACTICE_ASSESSMENT_RULES.md`
25. `FRONTEND_SYSTEM_DESIGN_GLOSSARY_PROJECTS.md`

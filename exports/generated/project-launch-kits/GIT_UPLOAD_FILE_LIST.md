# Git Upload File List

Use all 25 files from `exports/generated/git-standard/`:
...
21. `GIT_DOMAIN_CONTEXT.md`
22. `GIT_SYLLABUS.md`
23. `GIT_SKILL_GRAPH.md`
24. `GIT_GLOSSARY_PROJECTS.md`
25. `GIT_PRACTICE_ASSESSMENT_RULES.md`

...
- Canonical sources summarized: `specification/`, `core/`, `commands/`, `skills/`, and `domains/nodejs/`
...
- `START_LESSON`: teach the next appropriate Node.js concept deeply enough for reasoning, then request one guided learner action.

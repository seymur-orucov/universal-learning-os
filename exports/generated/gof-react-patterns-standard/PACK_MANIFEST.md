...
- Profile: standard
- Generated pack path: `C:\Self-study\universal-learning-os\exports\generated\gof-react-patterns-standard`
- File count: 25
...
- `docs/VISION.md`
- `domains/gof-react-patterns/ASSESSMENT_RULES.md`
- `domains/gof-react-patterns/DOMAIN.md`
- `domains/gof-react-patterns/GLOSSARY.md`
- `domains/gof-react-patterns/PRACTICE_RULES.md`
- `domains/gof-react-patterns/PROJECTS.md`
- `domains/gof-react-patterns/QUALITY_REVIEW.md`
- `domains/gof-react-patterns/SKILL_GRAPH.md`
- `domains/gof-react-patterns/SYLLABUS.md`

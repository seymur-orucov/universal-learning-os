# Front-End Testing Mentor OS Compact
...
- Canonical sources summarized: `specification/`, `core/`, `commands/`, `skills/`, and `domains/frontend-testing/`
...
- `START_LESSON`: teach the next appropriate Front-End Testing concept deeply enough for reasoning, then request one guided learner action.

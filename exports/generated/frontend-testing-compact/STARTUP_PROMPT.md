...
Start by asking whether learner state or a previous session summary exists. If no state exists, begin with a beginner-safe Front-End Testing diagnostic or first lesson.

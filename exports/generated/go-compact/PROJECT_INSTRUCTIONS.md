...
- Canonical sources summarized: `specification/`, `core/`, `commands/`, `skills/`, and `domains/go/`
...
- Keep Go, backend, concurrency, systems, and production engineering technical terms in English where natural.
...
- `START_LESSON`: teach the next appropriate Go concept deeply enough for reasoning, then request one guided learner action.

...
- Domain title: Git
- Profile: standard
- Generated pack path: `C:\Self-study\universal-learning-os\exports\generated\git-standard`
- File count: 25
...
- `docs/VISION.md`
- `domains/git/ASSESSMENT_RULES.md`
- `domains/git/DOMAIN.md`
- `domains/git/GLOSSARY.md`
- `domains/git/PRACTICE_RULES.md`
- `domains/git/PROJECTS.md`
- `domains/git/QUALITY_REVIEW.md`
- `domains/git/SKILL_GRAPH.md`
- `domains/git/SYLLABUS.md`

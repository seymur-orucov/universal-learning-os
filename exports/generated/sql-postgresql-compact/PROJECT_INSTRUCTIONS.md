...
- Canonical sources summarized: `specification/`, `core/`, `commands/`, `skills/`, and `domains/sql-postgresql/`
...
- `START_LESSON`: teach the next appropriate SQL/PostgreSQL concept deeply enough for reasoning, then request one guided learner action.

...
- Domain title: JavaScript
- Profile: standard
- Generated pack path: `C:\Self-study\universal-learning-os\exports\generated\javascript-standard`
- File count: 25
...
- `JAVASCRIPT_DOMAIN_CONTEXT.md`
- `JAVASCRIPT_SYLLABUS.md`
- `JAVASCRIPT_SKILL_GRAPH.md`
- `JAVASCRIPT_GLOSSARY_PROJECTS.md`
- `JAVASCRIPT_PRACTICE_ASSESSMENT_RULES.md`
...
- `docs/VISION.md`
- `domains/javascript/ASSESSMENT_MODEL.md`
- `domains/javascript/ASSESSMENT_RULES.md`
- `domains/javascript/DOMAIN.md`
- `domains/javascript/DOMAIN_OVERVIEW.md`
- `domains/javascript/GLOSSARY.md`
- `domains/javascript/MASTERY_EXPECTATIONS.md`
- `domains/javascript/MENTOR_BEHAVIOR.md`
- `domains/javascript/PRACTICE_MODEL.md`
- `domains/javascript/PRACTICE_RULES.md`
- `domains/javascript/PROJECTS.md`
- `domains/javascript/PROJECT_PACK_SELECTION.md`
- `domains/javascript/SKILL_GRAPH.md`
- `domains/javascript/SYLLABUS.md`

...
- Profile: standard
- Generated pack path: `C:\Self-study\universal-learning-os\exports\generated\dsa-standard`
- File count: 25
...
- `DSA_DOMAIN_CONTEXT.md`
- `DSA_SYLLABUS.md`
- `DSA_SKILL_GRAPH.md`
- `DSA_GLOSSARY_PROJECTS.md`
- `DSA_PRACTICE_ASSESSMENT_RULES.md`
...
- `docs/VISION.md`
- `domains/dsa/ASSESSMENT_RULES.md`
- `domains/dsa/DOMAIN.md`
- `domains/dsa/GLOSSARY.md`
- `domains/dsa/PRACTICE_RULES.md`
- `domains/dsa/PROJECTS.md`
- `domains/dsa/QUALITY_REVIEW.md`
- `domains/dsa/SKILL_GRAPH.md`
- `domains/dsa/SYLLABUS.md`

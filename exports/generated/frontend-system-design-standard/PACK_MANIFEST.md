...
- Profile: standard
- Generated pack path: `C:\Self-study\universal-learning-os\exports\generated\frontend-system-design-standard`
- File count: 25
...
- `FRONTEND_SYSTEM_DESIGN_DOMAIN_CONTEXT.md`
- `FRONTEND_SYSTEM_DESIGN_SYLLABUS.md`
- `FRONTEND_SYSTEM_DESIGN_SKILL_GRAPH.md`
- `FRONTEND_SYSTEM_DESIGN_GLOSSARY_PROJECTS.md`
- `FRONTEND_SYSTEM_DESIGN_PRACTICE_ASSESSMENT_RULES.md`
...
- `docs/VISION.md`
- `domains/frontend-system-design/ASSESSMENT_RULES.md`
- `domains/frontend-system-design/DOMAIN.md`
- `domains/frontend-system-design/GLOSSARY.md`
- `domains/frontend-system-design/PRACTICE_RULES.md`
- `domains/frontend-system-design/PROJECTS.md`
- `domains/frontend-system-design/QUALITY_REVIEW.md`
- `domains/frontend-system-design/SKILL_GRAPH.md`
- `domains/frontend-system-design/SYLLABUS.md`

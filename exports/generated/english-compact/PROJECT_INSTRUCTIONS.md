...
- Canonical sources summarized: `specification/`, `core/`, `commands/`, `skills/`, and `domains/english/`
...
- `START_LESSON`: teach the next appropriate English concept deeply enough for reasoning, then request one guided learner action.

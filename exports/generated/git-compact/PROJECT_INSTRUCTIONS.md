...
- Canonical sources summarized: `specification/`, `core/`, `commands/`, `skills/`, and `domains/git/`

## Purpose

Develop mental-model-first, recovery-aware Git competence from everyday repository work to advanced collaboration, release governance, debugging, and workflow design.

## Localization

- Instruction language: Azerbaijani.
- Keep Git commands and version-control technical terms in English where natural.
...
- `START_LESSON`: teach the next appropriate Git concept deeply enough for reasoning, then request one guided learner action.

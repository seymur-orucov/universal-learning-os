...
- `exports/project-pack-spec/FILE_BUDGET.md`: standard 25-file and generated compact/free 5-file budget models and allocation guidance.
...
These documents define export architecture only. They do not create actual Project Packs, bundled summaries, scripts, schemas, learner state, or executable tooling.

...
- `commands/SAVE_LESSON.md` (separately labeled merge)
...
- `skills/lesson-summary-builder/SKILL.md` (separately labeled merge)
- `skills/obsidian-lesson-exporter/SKILL.md` (separately labeled merge)

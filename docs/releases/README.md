...
- `docs/decisions/ADR-0057-git-domain.md`
...
- Supported domains: `sql-postgresql`, `english`, `javascript`, `typescript`, `dsa`, `frontend-system-design`, `nodejs`, and `git`.
- Standard packs: exactly 25 files per supported domain.
- Compact packs: exactly 5 files per supported domain.
- Generated packs checked: 16.

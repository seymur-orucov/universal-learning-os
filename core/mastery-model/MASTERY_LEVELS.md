...
- M3 Guided Application: the learner can apply the skill with support, hints, or scaffolding.
- M4 Independent Application: the learner can apply the skill without material support in a familiar context.
- M5 Real-World Transfer: the learner can apply the skill in realistic, novel, or integrated contexts.
- M6 Explain and Defend: the learner can justify decisions, explain tradeoffs, and respond to challenge.

## Normative Requirements

- Mastery levels MUST be supported by evidence as defined in `EVIDENCE_REQUIREMENTS.md`.
